...
type LayoutRouteId = RouteId | "/auth/sign-in" | "/auth/sign-up"
...
export type LayoutServerData = Expand<OptionalUnion<EnsureDefined<Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/auth/+layout.server.js').load>>>>>>;
